...
do
  ...
  antsJointLabelFusion2.sh -d 3 -o derivatives/fusion_warpfiles/sub-${i}/sub-${i}_malf_atlas${N}_QUICK_ -t sub-${i}/ses-1/anat/sub-${i}_ses-1_T1map.nii.gz $L_sub -k 1 -j $threads
